<?php
  ...
  class Users
  {
    ...
    {
      if(static::get($user) == $group) return false;
    ...
    public static function table()
    {
      \APLib\DB::query(
        "CREATE TABLE IF NOT EXISTS users_group(
          ...
          CONSTRAINT FK_ug_gn FOREIGN KEY (group_name) REFERENCES groups_privs(group_name) ON UPDATE CASCADE ON DELETE CASCADE
        ) ENGINE=INNODB"
      );
    }
  }
